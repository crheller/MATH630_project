...
off_task_env <- off_task %>%
  ...
  summarize(difference=mean(score))
...
Nice, we see that we've repicated the authors results, as well as added an **extension** plot to nicely illustrate that for ALL subjects we see an increase in time spent attenting to the environment in the deocrated classroom.
